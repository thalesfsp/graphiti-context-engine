...
export async function detectContradictions(
  ...
  for (const existing of existingClaims) {
    // Skip if same claim
    if (existing.claim_id === newClaim.claim_id) continue;
